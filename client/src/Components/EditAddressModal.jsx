...
import { patchApiRequestWrapper } from '../Networking/Services/ApiCalls';
...
const EditAddressModal = ({ selectedAddressData, handleModal, setAddressChanged }) => {

    const [addressData, setAddressData] = useState({
        receiver_name: selectedAddressData?.receiver_name || "",
        address_line: selectedAddressData?.address_line || "",
    ...
    async function handleAddressSubmitRequest() {
        ...
        const FINAL_URL = APIConfig?.addressPath?.updateAddress;

        const response = await patchApiRequestWrapper(FINAL_URL, payload);
